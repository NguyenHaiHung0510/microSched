...
| **011c** | `subscription` + luồng gia hạn + **F6** (burn cố định/tháng) + `app_setting` tối thiểu (toggle hiện giá, ngưỡng "sắp hết hạn") | **Chưa có spec**, dàn ý ở `011a` §9 + `tracking-brief.md` §11. **Chạy GIỮA `011a` và `011b`**, không phải cuối: `011b` nhắc cả thuốc lẫn sub, phần nhắc sub cần `subscription` tồn tại — làm sau thì phải ship một nửa tính năng rồi quay lại. |
