...
- Xem [SECURITY.vi.md](SECURITY.vi.md) để báo cáo lỗ hổng qua GitHub private vulnerability reporting.
- Xem [CONTRIBUTING.vi.md](CONTRIBUTING.vi.md) trước khi mở thay đổi.
